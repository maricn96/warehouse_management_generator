...
public class TestPackageGeneration {
	...
	public static void main(String[] args) {
		...
		String destDir = System.getProperty("user.home") + File.separator + "__generated_test__";
		
		GeneratorOptions ejbOptions = new GeneratorOptions(destDir, "ejbclass", "./resources/templates/", "{0}.java", true, "ejb"); 				
